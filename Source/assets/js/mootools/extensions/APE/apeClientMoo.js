 ...
 * APE JSF Setup
 */
APE.Config.baseUrl = 'http://ape.engine/APE_JSF'; // APE JSF 
APE.Config.domain = 'ape.engine'; 
APE.Config.server = 'ape.ape.engine:6969'; // APE server URL
APE.Config.transport = 2; // JSONP

(function(){
	for (var i = 0; i < arguments.length; i++)
		APE.Config.scripts.push(APE.Config.baseUrl + '/Source/' + arguments[i] + '.js');
})('mootools-core', 'Core/APE', 'Core/Events', 'Core/Core', 'Core/Session', 'Pipe/Pipe', 'Pipe/PipeMulti', 'Pipe/PipeSingle', 'Request/Request', 'Request/Request.Stack', 'Request/Request.CycledStack', 'Transport/Transport.SSE', 'Transport/Transport.JSONP', 'Core/Utility', 'Core/JSON');
